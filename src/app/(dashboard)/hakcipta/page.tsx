...
export default function HakciptaPage() {
  ...
  return (
    <div style={{ position: "relative", maxWidth: "640px" }}>
      ...
      {/* Developer Card */}
      <motion.div initial={{ opacity: 0, y: 5 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.15, delay: 0.03 }}>
            ...
            <div style={{ padding: "20px 24px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                    <div style={{ width: "32px", height: "32px", borderRadius: "8px", background: "rgba(24, 119, 242, 0.08)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                      <User size={14} color="#1877f2" />
                    </div>
                    <div>
