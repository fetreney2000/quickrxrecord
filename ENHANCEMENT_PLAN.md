...
| 22 | ✅ **Laporan Defaulter** — ~~Disebut dalam README tetapi halaman laporan semasa hanya menunjukkan inventori/transaksi. Tambah laporan defaulter yang betul: pesakit yang tidak mengambil isi semula X hari melepasi tarikh isi semula yang dijangkakan.~~ **DILAKSANAKAN** — Tab "Defaulter" baharu pada halaman Laporan. Mengira tarikh jangkaan isi semula daripada tarikh bekalan terakhir + tempoh dibekalkan (menyokong Hari/Minggu/Bulan/Tahun). Ambang hari lewat boleh laras (1/3/5/7/14/21/30 hari). Menunjukkan pesakit tanpa sebarang bekalan. Eksport Excel/PDF disokong. | Intervensi kepatuhan. |
